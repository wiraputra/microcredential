...
export default function EditOrderPage() {
  ...
  return (
    <div className="space-y-4 w-full">
      ...
      )} {/* Conditionally render the EditOrderForm component to display the form for editing order details if the data is successfully fetched and there are no loading or error states, passing the fetched order data as a prop to the EditOrderForm component */}
    </div>
  );
}
