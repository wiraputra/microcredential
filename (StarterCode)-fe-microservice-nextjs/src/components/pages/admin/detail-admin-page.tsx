...
export default function DetailUserPage() {
  ...
  return (
    <div className="space-y-4 w-full">
      ...
      )} {/* Conditionally render the UserDetailCard component to display the user details if the data is successfully fetched and there are no loading or error states, passing the fetched user data as a prop to the UserDetailCard component */}
    </div>
  );
}
